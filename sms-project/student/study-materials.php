              ...
              <table class="table table-bordered">
                ...
                <tbody>
                      ...
                      <tr>
                          <td><?=$count++?></td>
                          <td><?=$att->title?></td>
                          <td><a href="<?="../dist/uploads/dist/uploads/kisspng-web-development-responsive-web-design-digital-mark-web-design-5acb1289875160.7034743315232579935543.png".$file_attachment; ?>">Download File</a></td>
                          <td><?=$class->title?></td>
                          <td><?=$subject->title?></td>
